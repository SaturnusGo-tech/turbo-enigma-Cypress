import { RegistrationLocators } from '../VerificationLocators/RegistrationLocators';
import { RegistrationData } from './Data/Data';
import EmailGenerator  from '../../../../../plugins/EmailGen/EmailGenerator'
/**
 * Supplier_Enrollment_Flow_Verification class:
...
class Supplier_Enrollment_Flow_Verification {
  ...
  OpenRequestAccessButton() {
    ...
    cy.get(RegistrationLocators.request_accessButton)
      .should('be.visible')
      .click()
      .then(($el) => {
  ...
  FillRegistrationForm() {
    ...
    cy.get(RegistrationLocators.firstName_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.lastName_input)
      .should('be.visible')
   ...
   cy.get(RegistrationLocators.email_input)
       .should('be.visible')
       .type(generatedEmail)
   ...
   cy.log(`Entered Email: ${generatedEmail}`);
    ...
    cy.get(RegistrationLocators.phone_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.jopTitle_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.organizationName_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.zip_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.password_input)
      .should('be.visible')
    ...
    cy.get(RegistrationLocators.passwordConfirm_input)
      .should('be.visible')
  ...
  SubmitRegistrationForm() {
    ...
    cy.get(RegistrationLocators.submitButton_action)
      .should('be.visible')
      .click()
      .then(() => {
  ...
  VerifyConfirmationText() {
    ...
    cy.contains(RegistrationLocators.ConfirmationText)
      .should('be.visible')
      .then(($el) => {
